                        ...
                        if "success" in ket_qua_thuc_thi and ket_qua_thuc_thi["success"]:
                            ...
                            if "stdout" in ket_qua_thuc_thi and ket_qua_thuc_thi["stdout"]:
                                ...
                                session_memory.append(
                                    {
                                        "role": "system",
                                        "content": f"[PLUGIN: ThucThiPython] Output:\n{ket_qua_thuc_thi['stdout']}",
                                    }
                                )
                                ...
                                session_memory.append(
                                    {
                                        "role": "system",
                                        "content": f"[PLUGIN: ThucThiPython] {cau_hinh.RED}Error: {cau_hinh.RESET}\n[==================================================================================================]\n{ket_qua_thuc_thi['stderr']}\n[==================================================================================================]",
                                    }
                                )
                            if "disk_info" in ket_qua_thuc_thi and ket_qua_thuc_thi["disk_info"]:
                                ...
                                session_memory.append(
                                    {
                                        "role": "system",
                                        "content": f"[PLUGIN: ThucThiPython] Thông tin ổ đĩa:\n"
                                        + "\n".join(
                                            [
                                                f"  {disk['caption']} ({disk['description']}):\n    Size: {disk['size']} GB\n    Free Space: {disk['free_space']} GB\n    File System: {disk['file_system']}"
                                                for disk in ket_qua_thuc_thi["disk_info"][
                                                    "disk_info"
                                                ]
                                            ]
                                        ),
                            ...
                            if "stack_trace" in ket_qua_thuc_thi:
                                ...
                                session_memory.append(
                                    {
                                        "role": "system",
                                        "content": f"[PLUGIN: ThucThiPython] {cau_hinh.RED}Stack trace:{cau_hinh.RESET}\n{ket_qua_thuc_thi['stack_trace']}",
                                    }
                                )
                except Exception as e:
                    print(
